...
public class TestPay {
    ...
    public void getRedeemCodeSuccessful() throws Exception {
        ...
        PayResponseBean result = JSON.parseObject(HttpClientUtil.doPost("https://dev-environmental.vcinema.cn:3505"+PartnerInfo.pay_action,parameter),PayResponseBean.class);
    ...
    public void getPayStatisticsSuccessful() throws NoSuchAlgorithmException, InvalidKeyException, IOException {
        ...
        PayStatisticsResponseBean result = JSON.parseObject(HttpClientUtil.doGet("https://dev-environmental.vcinema.cn:3505"+PartnerInfo.pay_statistics_action,params),PayStatisticsResponseBean.class);
        assertEquals("200",result.getStatusCode());
    }
    ...
    public void payOrderSuccessful() throws Exception {
        ...
        String order_number = "2000141001231";
        String productId = "TEST_PUMPKIN_PRODUCT_ID";
        String account = "13960000001";
        String amount = "1";
        ...
        PayResponseBean result = JSON.parseObject(HttpClientUtil.doPost("https://dev-environmental.vcinema.cn:3505"+PartnerInfo.pay_order_action,parameter),PayResponseBean.class);
    ...
    public void payOrderOperatorSuccessful() throws Exception {
        ...
        HNUnicomRspEntity result = JSON.parseObject(HttpClientUtil.doPost("https://dev-environmental.vcinema.cn:3505"+PartnerInfo.pay_order_operator_action,parameter),HNUnicomRspEntity.class);
...
//        String account = "13323250325";
        ...
        HNUnicomRspEntity result = JSON.parseObject(HttpClientUtil.doPost("https://dev-environmental.vcinema.cn:3505"+PartnerInfo.pay_order_shdx_action,parameter),HNUnicomRspEntity.class);
    ...
    public void getOrder() throws Exception {
        ...
        PayResponseBean result = JSON.parseObject(HttpClientUtil.doPost("https://dev-environmental.vcinema.cn:3505"+PartnerInfo.get_order_action,parameter),PayResponseBean.class);
        System.out.println(result);
        assertEquals("200",result.getStatusCode());
    }
    ...
    public void getOrdersByPidAndDateSuccessful() throws Exception {
        ...
        PayResponseBean result = JSON.parseObject(HttpClientUtil.doPost("https://dev-environmental.vcinema.cn:3505"+PartnerInfo.get_order_by_date_action,parameter),PayResponseBean.class);
        System.out.println(result);
        assertEquals("200",result.getStatusCode());
    }
    ...
    public void sendInsufficientBalanceSMSSuccessful() throws Exception {
        ...
        SendSMSRepEntity result = JSON.parseObject(HttpClientUtil.doPost("https://dev-environmental.vcinema.cn:3505"+PartnerInfo.send_insufficient_balance_msg_action,parameter),SendSMSRepEntity.class);
